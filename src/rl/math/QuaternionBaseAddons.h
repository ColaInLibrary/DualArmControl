 ...
 * @Date          : 24-10-22
 * @Version       : 0.0.1
 * @File          : QuaternionBaseAddons.h
 ******************************************************************************
 */

#ifndef DUALARMCONTROL_SRC_MATH_QUATERNIONBASEADDONS_H_
#define DUALARMCONTROL_SRC_MATH_QUATERNIONBASEADDONS_H_
...
#endif  // DUALARMCONTROL_SRC_MATH_QUATERNIONBASEADDONS_H_

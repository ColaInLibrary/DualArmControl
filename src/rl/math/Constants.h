...
#ifndef DUALARMCONTROL_SRC_MATH_CONSTANTS_H_
#define DUALARMCONTROL_SRC_MATH_CONSTANTS_H_
...
class Constants {
 public:
  ...
  static constexpr T inv_pi =
      static_cast<T>(0.318309886183790671537767526745028724L);

  static constexpr T inv_sqrtpi =
  ...
  static constexpr T inv_sqrt3 =
      static_cast<T>(0.577350269189625764509148780501957456L);

  static constexpr T egamma =
   ...
   *
   * [Standard gravity](https://en.wikipedia.org/wiki/Standard_gravity) is the
   * nominal [gravitational
   * acceleration](https://en.wikipedia.org/wiki/Gravitational_acceleration) of
   * an object in a vacuum near the surface of the earth. It is defined
   * as 9.80665 m &middot; s<sup>-2</sup> by [ISO
   * 80000-3](https://en.wikipedia.org/wiki/ISO_80000-3).
   */
...
#endif  // DUALARMCONTROL_SRC_MATH_CONSTANTS_H_

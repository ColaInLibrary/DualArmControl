...
#ifndef RL_SRC_RL_MDL_MODEL_H_
#define RL_SRC_RL_MDL_MODEL_H_
...
class RL_MDL_EXPORT Model {
 public:
  ...
  RL_MDL_DEPRECATED void add(Transform* transform, const Frame* a,
                             const Frame* b);

  void add(const ::std::shared_ptr<Transform>& transform, const Frame* a,
           const Frame* b);

  bool areColliding(const ::std::size_t& i, const ::std::size_t& j) const;

  ::rl::math::Vector generatePositionGaussian(const ::rl::math::Vector& mean,
                                              const ::rl::math::Vector& sigma);

  ::rl::math::Vector generatePositionGaussian(
  ...
  ::rl::math::Vector generatePositionUniform(const ::rl::math::Vector& min,
  ...
  ::Eigen::Matrix<::rl::math::Units, ::Eigen::Dynamic, 1> getAccelerationUnits()
      const;
  ...
  const ::rl::math::MotionVector& getOperationalAcceleration(
      const ::std::size_t& i) const;

  ::std::size_t getOperationalDof() const;

  const ::rl::math::ForceVector& getOperationalForce(
      const ::std::size_t& i) const;

  Frame* getOperationalFrame(const ::std::size_t& i) const;

  const ::rl::math::Transform& getOperationalPosition(
      const ::std::size_t& i) const;

  const ::rl::math::MotionVector& getOperationalVelocity(
      const ::std::size_t& i) const;
  ...
  ::Eigen::Matrix<::rl::math::Units, ::Eigen::Dynamic, 1> getPositionUnits()
      const;
  ...
  ::Eigen::Matrix<::rl::math::Units, ::Eigen::Dynamic, 1> getTorqueUnits()
      const;

  ::rl::math::Vector getVelocity() const;

  ::Eigen::Matrix<::rl::math::Units, ::Eigen::Dynamic, 1> getVelocityUnits()
      const;
  ...
  void setOperationalVelocity(const ::std::size_t& i,
 ...
 protected:
  typedef ::boost::adjacency_list<
      ...
      ::std::shared_ptr<Frame>, ::std::shared_ptr<Transform>,

...
void XmlFactory::load(const ::std::string& filename, Model* model) {
  ::rl::xml::DomParser parser;

  ::rl::xml::Document document =
      parser.readFile(filename, "", XML_PARSE_NOENT | XML_PARSE_XINCLUDE);
  document.substitute(XML_PARSE_NOENT | XML_PARSE_XINCLUDE);

  if ("stylesheet" == document.getRootElement().getName() ||
      "transform" == document.getRootElement().getName()) {
    if ("1.0" == document.getRootElement().getProperty("version")) {
      if (document.getRootElement().hasNamespace() &&
          "http://www.w3.org/1999/XSL/Transform" ==
              document.getRootElement().getNamespace().getHref()) {
  ...
  ::rl::xml::NodeSet models =
      path.eval("(/rl/mdl|/rlmdl)/model").getValue<::rl::xml::NodeSet>();

  if (models.empty()) {
    throw Exception("rl::mdl::XmlFactory::load() - No models found in file '" +
                    filename + "'");
  }
  ...
  for (int i = 0; i < ::std::min(1, models.size()); ++i) {
    ...
    model->setManufacturer(
        path.eval("string(manufacturer)").getValue<::std::string>());
    ...
    ::rl::xml::NodeSet frames =
        path.eval("body|frame|world").getValue<::rl::xml::NodeSet>();
    ...
    for (int j = 0; j < frames.size(); ++j) {
      ...
      if ("body" == frames[j].getName()) {
        ...
        b->setInertia(path.eval("number(i/xx)").getValue<::rl::math::Real>(1),
        ...
        b->setMass(path.eval("number(m)").getValue<::rl::math::Real>(1));
        ...
        w->x.linear() =
            ::rl::math::AngleAxis(
                path.eval("number(rotation/z)").getValue<::rl::math::Real>(0) *
                    ::rl::math::constants::deg2rad,
                ::rl::math::Vector3::UnitZ()) *
            ::rl::math::AngleAxis(
                path.eval("number(rotation/y)").getValue<::rl::math::Real>(0) *
                    ::rl::math::constants::deg2rad,
                ::rl::math::Vector3::UnitY()) *
            ::rl::math::AngleAxis(
                path.eval("number(rotation/x)").getValue<::rl::math::Real>(0) *
                    ::rl::math::constants::deg2rad,
                ::rl::math::Vector3::UnitX())
                .toRotationMatrix();

        w->x.translation().x() =
            path.eval("number(translation/x)").getValue<::rl::math::Real>(0);
        w->x.translation().y() =
            path.eval("number(translation/y)").getValue<::rl::math::Real>(0);
        w->x.translation().z() =
            path.eval("number(translation/z)").getValue<::rl::math::Real>(0);

        w->setGravity(::rl::math::Vector3(
      ...
      if (nullptr != frame) {
        ...
        if (id2frame.find(frame->getName()) != id2frame.end()) {
          throw Exception("rl::mdl::XmlFactory::load() - Frame with ID '" +
                          frame->getName() + "' not unique in file '" +
                          filename + "'");
        }
    ...
    for (int j = 0; j < frames.size(); ++j) {
      ...
      if ("body" == frames[j].getName()) {
        ...
        if (id2frame.find(b1Id) == id2frame.end()) {
          throw Exception("rl::mdl::XmlFactory::load() - Body with ID '" +
                          b1Id + "' not found in file '" + filename + "'");
        }

        Body* b1 = dynamic_cast<Body*>(id2frame[b1Id]);

        ::rl::xml::NodeSet ignores =
            path.eval("ignore").getValue<::rl::xml::NodeSet>();
        ...
        for (int k = 0; k < ignores.size(); ++k) {
          if (!ignores[k].getProperty("idref").empty()) {
            ...
            if (id2frame.find(b2IdRef) == id2frame.end()) {
              throw Exception(
                  "rl::mdl::XmlFactory::load() - Body with IDREF '" + b2IdRef +
                  "' in Body with ID '" + b1Id + "' not found in file '" +
                  filename + "'");
            }
    ...
    ::rl::xml::NodeSet transforms =
        path.eval(
                "cylindrical|fixed|helical|prismatic|revolute|sixDof|spherical")
    ...
    for (int j = 0; j < transforms.size(); ++j) {
      ...
      ::std::string aIdRef =
          path.eval("string(frame/a/@idref)").getValue<::std::string>();

      if (id2frame.find(aIdRef) == id2frame.end()) {
        throw Exception("rl::mdl::XmlFactory::load() - Frame A with IDREF '" +
                        aIdRef + "' in Transform with ID '" + name +
      ...
      ::std::string bIdRef =
          path.eval("string(frame/b/@idref)").getValue<::std::string>();

      if (id2frame.find(bIdRef) == id2frame.end()) {
        throw Exception("rl::mdl::XmlFactory::load() - Frame B with IDREF '" +
                        bIdRef + "' in Transform with ID '" + name +
                        "' not found in file '" + filename + "'");
      }
      ...
      if ("cylindrical" == transforms[j].getName()) {
        ...
        c->max(0) = path.eval("number(max[1])")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        c->min(0) = path.eval("number(min[1])")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        c->offset(0) =
            path.eval("number(offset[1])").getValue<::rl::math::Real>(0);
        c->speed(0) =
            path.eval("number(speed[1])").getValue<::rl::math::Real>(0);
        c->wraparound(0) =
            path.eval("count(wraparound[1]) > 0").getValue<bool>();

        c->max(1) = path.eval("number(max[2])")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        c->min(1) = path.eval("number(min[2])")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        c->offset(1) =
            path.eval("number(offset[2])").getValue<::rl::math::Real>(0);
        c->speed(1) =
            path.eval("number(speed[2])").getValue<::rl::math::Real>(0);
        c->wraparound(1) =
            path.eval("count(wraparound[2]) > 0").getValue<bool>();

        c->S(0, 0) =
            path.eval("number(axis[1]/x)").getValue<::rl::math::Real>(0);
        c->S(1, 0) =
            path.eval("number(axis[1]/y)").getValue<::rl::math::Real>(0);
        c->S(2, 0) =
            path.eval("number(axis[1]/z)").getValue<::rl::math::Real>(1);

        c->S(3, 1) =
            path.eval("number(axis[2]/x)").getValue<::rl::math::Real>(0);
        c->S(4, 1) =
            path.eval("number(axis[2]/y)").getValue<::rl::math::Real>(0);
        c->S(5, 1) =
            path.eval("number(axis[2]/z)").getValue<::rl::math::Real>(1);
        ...
        h->max(0) = path.eval("number(max)")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        h->min(0) = path.eval("number(min)")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        h->offset(0) =
            path.eval("number(offset)").getValue<::rl::math::Real>(0);
        ...
        p->max(0) = path.eval("number(max)")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        p->min(0) = path.eval("number(min)")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        p->offset(0) =
            path.eval("number(offset)").getValue<::rl::math::Real>(0);
        ...
        r->max(0) = path.eval("number(max)")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        r->min(0) = path.eval("number(min)")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        r->offset(0) =
            path.eval("number(offset)").getValue<::rl::math::Real>(0);
        ...
        s->max(0) = path.eval("number(max[1])")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        s->max(1) = path.eval("number(max[2])")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        s->max(2) = path.eval("number(max[3])")
                        .getValue<::rl::math::Real>(
                            ::std::numeric_limits<::rl::math::Real>::max());
        s->min(0) = path.eval("number(min[1])")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        s->min(1) = path.eval("number(min[2])")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        s->min(2) = path.eval("number(min[3])")
                        .getValue<::rl::math::Real>(
                            -::std::numeric_limits<::rl::math::Real>::max());
        s->offset(0) =
            path.eval("number(offset[1])").getValue<::rl::math::Real>(0);
        s->offset(1) =
            path.eval("number(offset[2])").getValue<::rl::math::Real>(0);
        s->offset(2) =
            path.eval("number(offset[3])").getValue<::rl::math::Real>(0);
        s->speed(0) =
            path.eval("number(speed[1])").getValue<::rl::math::Real>(0);
        s->speed(1) =
            path.eval("number(speed[2])").getValue<::rl::math::Real>(0);
        s->speed(2) =
            path.eval("number(speed[3])").getValue<::rl::math::Real>(0);
    ...
    ::rl::xml::NodeSet home =
        path.eval("home/q").getValue<::rl::xml::NodeSet>();

    if (home.size() > 0) {
      if (home.size() != model->getDofPosition()) {
        throw Exception(
            "rl::mdl::XmlFactory::load() - Incorrect size of home position "
            "vector in file '" +
            filename + "'");
      }
      ...
      for (int j = 0; j < home.size(); ++j) {
        q(j) = ::boost::lexical_cast<::rl::math::Real>(
            home[j].getContent().c_str());
    ...
    ::rl::xml::NodeSet gammaPosition =
        path.eval("gammaPosition").getValue<::rl::xml::NodeSet>();
    ...
    for (int j = 0; j < gammaPosition.size(); ++j) {
      ...
      ::std::size_t n =
          path.eval("count(row[1]/col)").getValue<::std::size_t>(0);

      if (m != model->getDofPosition()) {
        throw Exception(
            "rl::mdl::XmlFactory::load() - Incorrect number of rows in gamma "
            "position matrix in file '" +
            filename + "'");
      }
      ...
      for (int k = 0; k < rows.size(); ++k) {
        ...
        if (path.eval("count(col)").getValue<::std::size_t>(0) !=
            model->getDofPosition()) {
          throw Exception(
              "rl::mdl::XmlFactory::load() - Incorrect number of columns in "
              "gamma position matrix in file '" +
              filename + "'");
        }

        ::rl::xml::NodeSet cols =
            path.eval("col").getValue<::rl::xml::NodeSet>();

        for (int l = 0; l < cols.size(); ++l) {
          G(k, l) = ::boost::lexical_cast<::rl::math::Real>(
              cols[l].getContent().c_str());
        }
      }
    ...
    ::rl::xml::NodeSet gammaVelocity =
        path.eval("gammaVelocity").getValue<::rl::xml::NodeSet>();
